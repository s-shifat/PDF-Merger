...
- You can directly download and use the `merger_gui.exe` from directory [dist](https://github.com/s-shifat/mrg-pdf/tree/main/dist) <br> 
  ...
  *As this executable is not used frequently you might need to disable your anti-virus application before downloading also might need to grant permission during execution*
